                ...
                <div className='main payment'>
                    <button className='border input paymentButton'>Pay with:
                        <svg width="99" height="60" viewBox="0 0 99 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M48.8864 11.2898C48.9567 11.237 49.0249 11.1868 49.0909 11.139C49.1569 11.1868 49.2251 11.237 49.2955 11.2898C50.1776 11.9514 51.3815 13.0015 52.5933 14.5163C54.9915 17.514 57.5 22.4255 57.5 30C57.5 37.5745 54.9915 42.486 52.5933 45.4837C51.3815 46.9985 50.1776 48.0486 49.2955 48.7102C49.2251 48.763 49.1569 48.8132 49.0909 48.861C49.0249 48.8132 48.9567 48.763 48.8864 48.7102C48.0043 48.0486 46.8003 46.9985 45.5885 45.4837C43.1903 42.486 40.6818 37.5745 40.6818 30C40.6818 22.4255 43.1903 17.514 45.5885 14.5163C46.8003 13.0015 48.0043 11.9514 48.8864 11.2898ZM50.2222 49.5888C50.224 49.5897 50.2234 49.5894 50.2203 49.5878L50.2222 49.5888Z" fill="#C275FF" stroke="black" strokeWidth="5"/>
                        </svg>
                    </button>
                    <button className='border input paymentButton'>Pay with:
